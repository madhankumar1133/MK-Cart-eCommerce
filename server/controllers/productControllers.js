...
exports.updateproduct=async (req,res,next)=>{
   ...
   //images not cleared they keep existing images
...
//get reviews -api/v1/reviews?id={producId}
...
//get admin products-api/va/admin/products

exports.getadminProducts=catchAsyncError(async (ereq,res,next) => {
